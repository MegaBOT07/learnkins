      ...
      <section className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="flex items-center justify-center space-x-2 text-sm font-bold mb-6">
            ...
            <span className="text-cyan-400">Meet Our Team</span>
          </div>
          <div className="inline-flex items-center px-4 py-2 bg-cyan-500/20 border-2 border-cyan-500 rounded-full mb-4">
            <Users className="h-5 w-5 text-cyan-400 mr-2" />
            <span className="font-bold text-cyan-400 text-sm uppercase tracking-wider">Our Team</span>
          </div>
