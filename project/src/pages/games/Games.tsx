...
const Games = () => {
  ...
  const games = [
    { id: 1, title: "NCERT Maths Adventure", category: "math", description: "Master mathematics through interactive challenges and real-world problem-solving.", difficulty: "Medium", players: 1250, rating: 4.8, duration: "15-20 min", image: "/games/treasurehunt.png", border: "border-green-500", badges: ["Hot", "Popular"], features: ["3D Graphics", "Leaderboard"], gameUrl: "/games/maths-adventure" },
    ...
    { id: 3, title: "Grammar Warrior", category: "english", description: "Battle grammar challenges and master English language skills.", difficulty: "Medium", players: 850, rating: 4.6, duration: "10-15 min", image: "/games/englishworrior.png", border: "border-purple-500", badges: ["Trending"], features: ["3D Battle", "Vocabulary"], gameUrl: "/games/grammar-warrior" },
    { id: 4, title: "Chemistry Mixer", category: "science", description: "Mix chemicals, solve formulas, and master the elements!", difficulty: "Hard", players: 720, rating: 4.5, duration: "15-20 min", image: "https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-cyan-500", badges: ["Lab"], features: ["Experiments", "Reactions"], gameUrl: "/games/chemistry-mixer" },
    { id: 5, title: "Geography Explorer", category: "social", description: "Navigate the globe and discover fascinating places and cultures.", difficulty: "Easy", players: 1050, rating: 4.8, duration: "15-20 min", image: "https://images.pexels.com/photos/1066895/pexels-photo-1066895.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-yellow-500", badges: ["Global"], features: ["Geography", "Maps"], gameUrl: "/games/geography-explorer" },
    { id: 6, title: "Science Lab", category: "science", description: "Conduct experiments in physics, biology, and test your scientific knowledge.", difficulty: "Medium", players: 930, rating: 4.7, duration: "15-20 min", image: "https://images.pexels.com/photos/2280549/pexels-photo-2280549.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-blue-500", badges: ["New"], features: ["Physics", "Biology"], gameUrl: "/games/science-lab" },
    { id: 7, title: "Word Builder", category: "english", description: "Unscramble words, build vocabulary, and become a language master!", difficulty: "Easy", players: 880, rating: 4.6, duration: "10-15 min", image: "https://images.pexels.com/photos/261662/pexels-photo-261662.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-purple-500", badges: ["New"], features: ["Vocabulary", "Spelling"], gameUrl: "/games/word-builder" },
    ...
    { id: 9, title: "CodeQuest", category: "science", description: "Learn web development through interactive coding challenges and quests!", difficulty: "Hard", players: 420, rating: 4.8, duration: "20-30 min", image: "https://images.pexels.com/photos/577585/pexels-photo-577585.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-cyan-500", badges: ["Coding", "New"], features: ["React", "Interactive"], gameUrl: "/games/code-quest" },
    { id: 10, title: "Virtual Science Lab", category: "science", description: "3D virtual lab with NCERT experiments for chemistry, physics, and biology!", difficulty: "Hard", players: 380, rating: 4.9, duration: "20-30 min", image: "https://images.pexels.com/photos/2280571/pexels-photo-2280571.jpeg?auto=compress&cs=tinysrgb&w=400", border: "border-green-500", badges: ["3D Lab", "New"], features: ["Three.js", "Experiments"], gameUrl: "/games/virtual-lab" },
  ];
