...
const Science = () => {
  ...
  const statItems = [
    { value: stats.totalVideos, label: "Videos", color: "text-purple-600", border: "border-purple-500" },
    ...
    { value: stats.totalQuizzes, label: "Quizzes", color: "text-blue-600", border: "border-blue-500" },
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white">
      ...
      {/* Header Section */}
      <section className="relative bg-purple-500 text-white border-b-4 border-black overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center space-x-3 text-sm font-bold uppercase tracking-wider mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <span className="px-3 py-1.5 bg-white text-purple-600 rounded-lg border-2 border-white font-black">Science</span>
          </div>
          <div className="flex items-center space-x-6">
            <div className="text-7xl p-4 bg-white/20 rounded-2xl border-2 border-white/30">🔬</div>
            <div>
              <h1 className="text-5xl lg:text-6xl font-black mb-4 uppercase tracking-tight">Science</h1>
              <p className="text-xl text-white/90 max-w-2xl font-medium">
                Explore the wonders of physics, chemistry, and biology through
                interactive experiments and engaging content.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {activeTab === "overview" && (
            <div>
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 font-medium">Explore scientific concepts through comprehensive study materials</p>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {chapters.map((chapter, idx) => {
                      const colors = ["border-purple-500", "border-blue-500", "border-green-500", "border-orange-500"];
                      return (
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {chapter.topics.map((topic, index) => (
                                  <span key={index} className="px-3 py-1 bg-purple-100 text-purple-800 rounded-lg text-xs font-bold border border-purple-200">{topic}</span>
                                ))}
                              </div>
                            </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1 mr-4">
                              ...
                              <div className="w-full bg-gray-200 rounded-full h-3 border-2 border-black overflow-hidden">
                                <div className="bg-purple-500 h-full rounded-full transition-all duration-500" style={{ width: `${chapter.progress}%` }} />
                              </div>
                            </div>
                            <Link
                              to={`/subjects/science/${chapter.id}`}
                              className="px-5 py-2.5 bg-black text-white rounded-xl font-bold border-2 border-black hover:bg-white hover:text-black transition-all active:scale-95 shadow-[3px_3px_0px_0px_rgba(0,0,0,0.2)]"
                            >
                              Start
                            </Link>
                          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {chapters.map((chapter) => (
                  <div key={chapter.id} className="bg-white rounded-2xl border-2 border-purple-500 overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                    <div className="bg-purple-500 h-48 flex items-center justify-center border-b-2 border-black">
                    ...
                    <div className="p-6">
                      ...
                      <Link to={`/subjects/science/${chapter.id}/videos`} className="block w-full text-center bg-black text-white py-3 px-4 rounded-xl font-bold border-2 border-black hover:bg-white hover:text-black transition-all active:scale-95">
                        Watch Videos
                      </Link>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {chapters.map((chapter) => (
                  <div key={chapter.id} className="bg-white rounded-2xl p-6 border-2 border-orange-500 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <div className="flex space-x-2">
                      <button 
                        onClick={() => navigate('/practice-quizzes?subject=science')}
          ...
          {activeTab === "assessments" && (
            <div>
              <div className="mb-8">
                <h2 className="text-3xl font-black text-black mb-2 uppercase tracking-tight">Worksheets</h2>
                <p className="text-lg text-gray-600 font-medium">Practice worksheets and assessments to test your science knowledge</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { id: "science-1", title: "Physics Fundamentals Test", description: "Test your knowledge of basic physics concepts including motion, forces, and energy", difficulty: "Intermediate", timeLimit: "12 min", questions: 5 },
                  { id: "science-2", title: "Chemical Reactions Assessment", description: "Test your understanding of chemical reactions and their types", difficulty: "Intermediate", timeLimit: "10 min", questions: 5 },
                  { id: "science-3", title: "Biology Basics Quiz", description: "Test your knowledge of fundamental biology concepts", difficulty: "Beginner", timeLimit: "8 min", questions: 5 },
                ].map((assessment) => (
                  <div key={assessment.id} className="bg-white rounded-2xl p-6 border-2 border-orange-500 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <a
                        href={`/${assessment.id === "science-1" ? "(3)History of Number Systems.docx" : assessment.id === "science-2" ? "(5)Number Play.docx" : assessment.id === "science-3" ? "(6)Distributive Property.docx" : ""}`}
                        download
