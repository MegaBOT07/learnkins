...
MongoDB URI: mongodb+srv://info_db_user:mMQT9NsO2gjDUS6B@cluster0.1gsz3vi.mongodb.net/learnkins?retryWrites=true&w=majority&appName=Cluster0
⚠️ MongoDB disconnected
❌ MongoDB connection error: querySrv ECONNREFUSED _mongodb._tcp.cluster0.1gsz3vi.mongodb.net
❌ MongoDB connection error: querySrv ECONNREFUSED _mongodb._tcp.cluster0.1gsz3vi.mongodb.net# LearnKins - Complete Backend Integration Guide
