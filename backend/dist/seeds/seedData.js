...
dotenv.config();
const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://mohitlalwani1907:aoLuqoa2jczEBnoj@cluster0.tzkp3vg.mongodb.net/learnkins";

// Sample subjects for 6th-8th grade
const gradeSubjects = [{
  name: "Mathematics - 6th Grade",
  slug: "mathematics-6th",
  description: "Master mathematical concepts from basic arithmetic to algebra and geometry.",
  icon: "🧮",
  color: "#3B82F6",
  grade: "6th",
  materials: [{
    title: "Basic Arithmetic",
    content: "Learn addition, subtraction, multiplication, and division with whole numbers and decimals.",
    type: "video",
    duration: 30
  }, {
  ...
  materials: [{
    ...
    content: "Understanding metaphors, similes, and other literary techniques.",
    type: "video",
    duration: 35
  }, {
...
// 8th Grade Quizzes
{
  ...
  questions: [{
    ...
    options: ["Law of Motion", "Law of Inertia", "Law of Action-Reaction", "Law of Acceleration"],
    correctAnswer: 1,
...
const gradeGames = [{
  ...
  description: "Solve mathematical puzzles to advance through levels and unlock new challenges.",
  type: "puzzle",
  difficulty: "medium",
  subject: "mathematics",
  grade: "6th"
  ...
  description: "Conduct virtual experiments and learn scientific principles through interactive simulations.",
  type: "simulation",
  difficulty: "easy",
  subject: "science",
  grade: "6th"
  ...
  description: "Build vocabulary and improve language skills through word games and challenges.",
  type: "word",
  difficulty: "medium",
  subject: "english",
  grade: "7th"
  ...
  description: "Travel through time and learn about historical events through interactive storytelling.",
  type: "adventure",
  difficulty: "easy",
  ...
  description: "Explore physics concepts through interactive simulations and experiments.",
  type: "simulation",
  difficulty: "medium",
  subject: "science",
  grade: "8th"
...
// 8th Grade
{
  ...
  answer: 'A figure of speech that compares two things without using "like" or "as"',
  subjectId: "english",
  grade: "8th",
  difficulty: "medium"
}, {
...
const gradeDiscussions = [{
  ...
  content: "I'm struggling with algebra. What are some effective study techniques that have worked for you? I've tried flashcards but looking for more interactive methods.",
  category: "mathematics",
  tags: ["study-tips", "algebra", "help"]
}, {
  title: "Science project ideas for 6th grade",
  content: "Looking for creative science project ideas that are both educational and fun. Any suggestions for experiments that can be done at home?",
  category: "science",
  tags: ["projects", "experiments", "6th-grade"]
}, {
  title: "How to improve reading comprehension",
  content: "I love reading but sometimes struggle with understanding complex texts. What strategies do you use to improve comprehension?",
  category: "english",
  tags: ["reading", "comprehension", "tips"]
}, {
  title: "Study group for history",
  content: "Anyone interested in forming a study group for social studies? We can discuss historical events and help each other prepare for tests.",
  category: "social-science",
  tags: ["study-group", "history", "collaboration"]
}, {
  title: "Tips for memorizing math formulas",
  content: "I find it really hard to remember all the math formulas. Does anyone have any memory techniques that work well?",
  category: "mathematics",
  tags: ["memory", "math", "study-tips"]
}, {
  title: "Science fair project ideas",
  content: "I need ideas for my science fair project. What are some interesting experiments that are appropriate for middle school?",
  category: "science",
  tags: ["science-fair", "projects", "experiments"]
}, {
  title: "Creative writing prompts",
  content: "I need some inspiration for my creative writing assignment. What are some interesting prompts that have worked well for you?",
  category: "english",
  tags: ["creative-writing", "prompts", "inspiration"]
}, {
  title: "Study schedule for finals",
  content: "Finals are coming up and I need to organize my study schedule. How do you balance studying for multiple subjects?",
  category: "general",
...
const gradeStudyGroups = [{
  name: "Math Wizards",
  description: "A group for students who love mathematics and want to help each other solve problems.",
  subject: "mathematics",
  maxMembers: 15,
  rules: ["Be respectful to all members", "Share your problem-solving approaches", "Help others when you can"],
  tags: ["algebra", "geometry", "problem-solving"]
}, {
  name: "Science Explorers",
  description: "Join us to explore the wonders of science through experiments and discussions.",
  subject: "science",
  maxMembers: 20,
  rules: ["Follow safety guidelines", "Share interesting discoveries", "Ask questions freely"],
  tags: ["chemistry", "physics", "biology", "experiments"]
}, {
  name: "English Literature Club",
  description: "Discuss books, improve writing skills, and share creative stories.",
  subject: "english",
  maxMembers: 12,
  rules: ["Respect different opinions", "Share your favorite books", "Practice creative writing"],
  tags: ["literature", "writing", "poetry"]
}, {
  name: "History Buffs",
  description: "Learn about historical events and their impact on the modern world.",
  subject: "social-science",
  maxMembers: 18,
  rules: ["Respect different cultures", "Share historical insights", "Fact-check information"],
...
const seedData = async () => {
  try {
    ...
    for (const subjectData of gradeSubjects) {
      ...
      for (const materialData of subjectData.materials) {
        await Material.create({
          ...
          grade: subjectData.grade,
          fileUrl: "https://example.com/materials/" + materialData.title.toLowerCase().replace(/\s+/g, "-"),
    ...
    const discussionPromises = gradeDiscussions.map(async (discussion, index) => {
    ...
    const chapters = {
      mathematics: ["Algebra Basics", "Geometry", "Statistics", "Number Theory"],
      science: ["Physics", "Chemistry", "Biology", "Environmental Science"],
      english: ["Grammar", "Literature", "Creative Writing", "Comprehension"],
      "social-science": ["Ancient History", "Modern History", "Geography", "Civics"]
    };
        ...
        for (const chapter of subjectChapters) {
          progressData.push({
            ...
            streak: {
              ...
              lastStudyDate: new Date(Date.now() - Math.floor(Math.random() * 7) * 24 * 60 * 60 * 1000)
            }
          });
        }
      }
    ...
    for (const student of students) {
      const randomAchievements = createdAchievements.slice(0, Math.floor(Math.random() * 3) + 1);
      student.achievements = randomAchievements.map(achievement => achievement._id);
      student.points = randomAchievements.reduce((sum, achievement) => sum + achievement.points, 0);
